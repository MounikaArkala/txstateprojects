...
class TreeNode(object):
    ...
    def add(self, data):
        ...
        if existingval == None:
            #was added without making any new subtrees.
...
def height(startNode, current=0, maxheight=0):
    #calculate height of the tree.  pretty straightforward.
...
def getClass(startNode, targetData):
    ...
    #we might end up at a None and then we return None
    ...
    if type(split_tree) == list:
        ...
        #which obviously means it found no match.
