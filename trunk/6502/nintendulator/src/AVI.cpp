 ...
 *
 * $URL: https://nintendulator.svn.sourceforge.net/svnroot/nintendulator/nintendulator/trunk/src/AVI.cpp $
 * $Id: AVI.cpp 996 2009-05-23 02:02:20Z Quietust $
 */
...
void	AddAudio (void)
{
	...
	hr = AddAviAudio(handle, APU::buffer, 735*2);
	if (hr)
	{
		TCHAR msg[256];
		FormatAviMessage(hr, msg, 256);
