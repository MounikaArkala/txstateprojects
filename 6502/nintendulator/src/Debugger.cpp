 ...
 *
 * $URL: https://nintendulator.svn.sourceforge.net/svnroot/nintendulator/nintendulator/trunk/src/Debugger.cpp $
 * $Id: Debugger.cpp 996 2009-05-23 02:02:20Z Quietust $
 */
		...
		for (t = 0; t < 2; t++)
		{
			for (y = 0; y < 16; y++)
			{
				for (x = 0; x < 16; x++)
				{
					...
					Debug_DrawTile(PatternArray + y * 8 * D_PAT_W + x * 8 + t * 128, MemAddr, Palette, D_PAT_W);
				}
			}
		}
